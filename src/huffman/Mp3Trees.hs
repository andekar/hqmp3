...
getTree x = case x of
    ...
    30  -> (tree 24, 11)
    31  -> (tree 24, 13)
    _   -> error "Bad HuffTree"

-- Quadruple trees below
-- These were also autogenerated :-)
qTreeA = 
    Node (Node (Node (Node (Node (Node (Leaf (1,0,1,1)) (Leaf (1,1,1,1)))
    (Node (Leaf (1,1,0,1)) (Leaf (1,1,1,0)))) (Node (Node (Leaf (0,1,1,1)) (Leaf
    (0,1,0,1))) (Leaf (1,0,0,1)))) (Node (Node (Leaf (0,1,1,0)) (Leaf
    (0,0,1,1))) (Node (Leaf (1,0,1,0)) (Leaf (1,1,0,0))))) (Node (Node (Leaf
    (0,0,1,0)) (Leaf (0,0,0,1))) (Node (Leaf (0,1,0,0)) (Leaf (1,0,0,0)))))
    (Leaf (0,0,0,0))

qTreeB = 
    Node (Node (Node (Node (Leaf (1,1,1,1)) (Leaf (1,1,1,0))) (Node (Leaf
    (1,1,0,1)) (Leaf (1,1,0,0)))) (Node (Node (Leaf (1,0,1,1)) (Leaf (1,0,1,0)))
    (Node (Leaf (1,0,0,1)) (Leaf (1,0,0,0))))) (Node (Node (Node (Leaf
    (0,1,1,1)) (Leaf (0,1,1,0))) (Node (Leaf (0,1,0,1)) (Leaf (0,1,0,0)))) (Node
    (Node (Leaf (0,0,1,1)) (Leaf (0,0,1,0))) (Node (Leaf (0,0,0,1)) (Leaf
    (0,0,0,0)))))


-- All these trees were autogenerated by the script in "CreateHuff.hs"
-- Modified to become a function, matching the hufftable numbers as 
-- described in iso-11172-3. These are the regular trees.

tree 0 = Leaf (0,0)
tree 1 = Node (Node (Node (Leaf (1,1)) (Leaf (0,1))) (Leaf (1,0))) (Leaf (0,0))
tree 2 = Node (Node (Node (Node (Node (Node (Leaf (2,2)) (Leaf (0,2)))
        (Leaf (1,2))) (Node (Leaf (2,1)) (Leaf (2,0)))) (Leaf (1,1)))
        (Node (Leaf (0,1)) (Leaf (1,0)))) (Leaf (0,0))
tree 3 = Node (Node (Node (Node (Node (Node (Leaf (2,2)) (Leaf (0,2))) 
        (Leaf (1,2))) (Node (Leaf (2,1)) (Leaf (2,0)))) (Leaf (1,0)))
        (Leaf (1,1))) (Node (Leaf (0,1)) (Leaf (0,0)))
tree 5 = Node (Node (Node (Node (Node (Node (Node (Node (Leaf (3,3)) 
        ...
        (Node (Leaf (0,1)) (Leaf (1,0)))) (Leaf (0,0))
tree 6 = Node (Node (Node (Node (Node (Node (Node (Leaf (3,3)) (Leaf (0,3))) 
...
tree 7 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Leaf (5,5))
        ...
        (1,0)))) (Leaf (0,0))
tree 8 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Leaf 
        ...
        (Leaf (1,0))) (Leaf (0,0)))
tree 9 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Leaf (5,5)) 
...
tree 10 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Node 
        ...
        (Leaf (1,0)))) (Leaf (0,0))
tree 11 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Leaf (7,7))
        ...
        (Leaf (0,0)))
tree 12 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Leaf (7,7))
        ...
        (1,0))))
tree 13 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Node
...
tree 15 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Node
        ...
        (1,0))) (Leaf (0,0))))
tree 16 = Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Node (Leaf
        ...
        (Node (Leaf (0,2)) (Leaf (2,0)))))) (Node (Node (Leaf (1,1)) (Leaf 
        (0,1))) (Leaf (1,0)))) (Leaf (0,0))
tree 24 = Node (Node (Node (Node (Node (Node (Node (Node (Leaf (14,15)) (Leaf 
